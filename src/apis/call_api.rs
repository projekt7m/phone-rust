...
pub async fn get_call_alarm(configuration: &configuration::Configuration, ) -> Result<models::AlarmCallData, Error<GetCallAlarmError>> {
...
pub async fn get_call_alarm_by_callee_e164_unsecure(configuration: &configuration::Configuration, e164: &str) -> Result<models::AlarmCallData, Error<GetCallAlarmByCalleeE164UnsecureError>> {
    let local_var_configuration = configuration;
