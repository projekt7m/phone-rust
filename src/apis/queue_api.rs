...
/// struct for typed errors of method [`queue_announce_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum QueueAnnounceGetError {
...
pub async fn queue_announce_get(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::AnnounceSwitchtime>, Error<QueueAnnounceGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/queue/announce", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<QueueAnnounceGetError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn queue_get(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::Queue>, Error<QueueGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<QueueGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
