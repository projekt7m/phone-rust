...
pub async fn get_block_by_id(configuration: &configuration::Configuration, id: &str) -> Result<crate::models::Block, Error<GetBlockByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_blocks(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::Block>, Error<GetBlocksError>> {
    let local_var_configuration = configuration;
...
pub async fn post_block(configuration: &configuration::Configuration, new_block: crate::models::NewBlock) -> Result<crate::models::Block, Error<PostBlockError>> {
    let local_var_configuration = configuration;
...
pub async fn put_block_by_id(configuration: &configuration::Configuration, id: &str, new_block: crate::models::NewBlock) -> Result<crate::models::Block, Error<PutBlockByIdError>> {
    let local_var_configuration = configuration;
