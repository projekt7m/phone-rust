...
pub struct ListWrapperAlarmCall {
    #[serde(rename = "data")]
    pub data: Vec<models::ListWrapperAlarmCallDataInner>,
}

impl ListWrapperAlarmCall {
    pub fn new(data: Vec<models::ListWrapperAlarmCallDataInner>) -> ListWrapperAlarmCall {
