...
impl QueueCaller {
    pub fn new(queue_caller_id: uuid::Uuid, tenant_id: uuid::Uuid, queue_id: uuid::Uuid, queue_number_id: uuid::Uuid, caller_number: String, prio: i32, ring_request: bool, start_time: String, last_change: String, next_check: String) -> QueueCaller {
        QueueCaller {
            queue_caller_id,
            tenant_id,
            queue_id,
