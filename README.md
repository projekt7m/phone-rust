...
*QueueApi* | [**delete_queues_queue_id_destinations_queue_number_id**](docs/QueueApi.md#delete_queues_queue_id_destinations_queue_number_id) | **DELETE** /queues/{qid}/destinations/{qdid} | Delete a destination from a queue
...
*QueueApi* | [**get_all_queues**](docs/QueueApi.md#get_all_queues) | **GET** /queues/all | Get all queues
...
*QueueApi* | [**get_queues_queue_id_destinations_queue_destination_id**](docs/QueueApi.md#get_queues_queue_id_destinations_queue_destination_id) | **GET** /queues/{qid}/destinations/{qdid} | Get a single queue destination
...
*QueueApi* | [**post_queues_queue_id_destinations**](docs/QueueApi.md#post_queues_queue_id_destinations) | **POST** /queues/{qid}/destinations | Add a destination to a queue
...
*QueueApi* | [**put_queues_queue_id_destinations_queue_destination_id**](docs/QueueApi.md#put_queues_queue_id_destinations_queue_destination_id) | **PUT** /queues/{qid}/destinations/{qdid} | Update a destination configuration of a queue
...
*VoicemailApi* | [**get_voicemail_qid**](docs/VoicemailApi.md#get_voicemail_qid) | **GET** /voicemail/{qid} | Get the list of all voicemails of a queue
*VoicemailApi* | [**get_voicemail_qid_vid**](docs/VoicemailApi.md#get_voicemail_qid_vid) | **GET** /voicemail/{qid}/{vid} | Get a single voicemail
*VoicemailApi* | [**post_voicemail_qid**](docs/VoicemailApi.md#post_voicemail_qid) | **POST** /voicemail/{qid} | Create a new voicemail message
*VoicemailApi* | [**put_voicemail_qid_vid**](docs/VoicemailApi.md#put_voicemail_qid_vid) | **PUT** /voicemail/{qid}/{vid} | Update the message text of a voicemail
...
## Documentation For Models
 ...
 - [ListWrapperVoicemail](docs/ListWrapperVoicemail.md)
 - [ListWrapperVoicemailDataInner](docs/ListWrapperVoicemailDataInner.md)
 ...
 - [NewQueueDestination](docs/NewQueueDestination.md)
 - [NewQueueNumber](docs/NewQueueNumber.md)
 - [NewQueueOpening](docs/NewQueueOpening.md)
 - [NewVoicemail](docs/NewVoicemail.md)
